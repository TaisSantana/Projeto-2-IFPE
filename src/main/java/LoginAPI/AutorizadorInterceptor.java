...
private static final String[] RECURSOS_LIVRES = {"/","/precadastroAluno","/assets","/login","/logout","/acesso-negado","/exibirPreCadastroAluno","/exibirFormCadastrarProf","exibirFormCadastrarAdm","/exibirFormCadastrarAulaPratica","/salvarAdm","/sobre","/paginaInicial"};
